     ...
     <body>
          ...
          <div id="menu" class="menu container black xxlarge padding-64">
               ...
               <div class="row center border border-dark-grey">
                    <a href="#pizza"><div class="third padding-large red">Pizza</div></a>
               </div>
               ...
               <div class="total-container">
                    ...
                    <a href="cart.php" class=" right tag red round cart-button"><i class="fa fa-shopping-cart"></i> Add to Cart</a>
               </div>
          </div>  
